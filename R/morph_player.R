...
morph_player_from_row <- function(
  ...
  screenshot::screenshot(file="./images/tmp_morph_gi_1.png")
  ss_gi_1 <- magick::image_read("./images/tmp_morph_gi_1.png")
  # Birth date
  magick::image_crop(ss_gi_1, "65x45+1270+580")
  # Birth month
  magick::image_crop(ss_gi_1, "120x40+1240+655")
  # Birth year
  magick::image_crop(ss_gi_1, "110x40+1250+730")
  # First position
  magick::image_crop(ss_gi_1, "80x45+1260+800")
  ...
  # Write out file ----
  add('
  FileAppend("done\\n", "C:/Users/colli/Documents/codeprojects/MVP2005/autohotkey/morph_player_p1_done.txt")
  ')
  # Beep when done
  add("
      SoundBeep(523, 500)")
  ...
  # Write it ----
  write(x=out, file="./autohotkey/morph_player_p1.ahk")
  
  # Execute it ----
  # system('"C:/Program Files/AutoHotkey/UX/AutoHotkeyUX.exe" C:/Users/colli/Documents/codeprojects/MVP2005/autohotkey/beep.ahk',
  #        wait=FALSE)
  system('"C:/Program Files/AutoHotkey/UX/AutoHotkeyUX.exe" C:/Users/colli/Documents/codeprojects/MVP2005/autohotkey/morph_player_p1.ahk',
         wait=FALSE)
